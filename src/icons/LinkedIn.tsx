...
const LinkedIn: React.FC<IconProps> = ({ size = 24, className = "" }) => {
    ...
    return (
        ...
        <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_288_545)" filter="url(#filter0_d_288_545)">
            ...
            <defs>
            <filter id="filter0_d_288_545" x="0" y="0.5" width="40" height="40" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
