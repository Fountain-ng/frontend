  ...
  return (
    ...
    <header className="distributor-navbar">
      ...
      <ul className={`navbar__menu-normal ${isMenuOpen ? 'navbar__menu--open' : ''}`}>
        ...
        {user ? (
          <Link to="/profile" className="navbar__link-normal log-in">
            PROFILE
          </Link>
        ) : (
          <Link to="/sign-in" className="navbar__link-normal log-in">
            LOG IN
          </Link>
        )}
      </ul>
      ...
      <div className="navbar__cta">
        ...
        <Link to={user ? "/profile" : "/sign-in"} className="navbar__cta-btn">
          <img
            src="/bx-user.svg"
            className="navbar__cta-img-normal"
            alt="user icon"
